    ...
    return (
        <section className={styles.about} id="about">
            <div className="container">
                ...
                >
                    <p>
                        製造・貿易・建設と複数業界を経験した後、ITインフラエンジニアに転向。サーバー運用とAWS移行の設計・構築・運用を主軸に、CloudWatch / CloudTrail を用いた監視、Linuxサーバーの権限管理、Lambdaによる簡易な自動化スクリプト作成にも携わってきました。
                        2025年12月からは、ServiceNow Japan とデロイト トーマツによる「RiseUp with ServiceNow」リスキリングプログラムに参加し、認定トレーニングとアプリ開発演習を含む体系的な学習を進めています。並行して職業訓練でフロントエンド開発も学び、ServiceNow のUI構築に必要な基礎を固めています。
                    </p>
                </motion.div>

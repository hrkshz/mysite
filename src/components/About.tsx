...
const engineerCareers: Career[] = [
    ...
    },
    {
        ...
        desc: 'オンプレミス環境から AWS への移行や OS 移行を含む複数案件で、設計・構築・運用対応を担当。',
    ...
    return (
        <section className={styles.about} id="about">
            <div className="container">
                ...
                >
                    <p>
                        製造・貿易・建設と複数業界を経験した後、ITインフラエンジニアに転向しました。サーバー運用と AWS 移行の設計・構築・運用を主軸に、CloudWatch / CloudTrail を用いた監視、Linux サーバーの権限管理、Lambda による簡易な自動化スクリプト作成など、安定運用と改善の両面に携わってきました。
                        複数業界で培った現場理解と調整力を活かし、現在はクラウド運用、セキュリティ、業務効率化・DX 推進に関わる領域へと経験を広げています。2025年12月からは ServiceNow のリスキリングプログラムにも参加し、業務改善やワークフロー設計に関する学習を継続しています。並行して職業訓練でフロントエンド開発も学び、業務システムや UI への理解も深めています。
                    </p>
                </motion.div>

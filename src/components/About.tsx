    ...
    return (
        <section className={styles.about} id="about">
            <div className="container">
                ...
                >
                    <p>
                        製造・貿易・建設と複数業界を経験した後、IT インフラエンジニアに転向しました。サーバー運用と AWS 移行の設計・構築・運用を主軸に、CloudWatch / CloudTrail を用いた監視、Linux サーバーの権限管理、Lambda による自動化など、安定運用と改善の両面に携わってきました。
                    </p>
                    <p>
                        複数業界で培った現場理解と調整力を活かし、次のキャリアではクラウド運用・セキュリティ・運用改善といった領域で貢献したいと考えています。学習面では、2026年1月から ServiceNow のリスキリングプログラムに参加しワークフロー設計を学習中で、並行して職業訓練でフロントエンド開発にも取り組んでいます。
                    </p>
                </motion.div>

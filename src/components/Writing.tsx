            ...
            <div className="container">
                ...
                >
                    <div className={styles.cardHeader}>
                        ...
                        <div>
                            ...
                            <p className={styles.cardLead}>
                                AWS / Terraform / Linux に加え、Lambda やログ分析まわりの学習記録・検証内容を公開しています。
                            </p>
                        </div>
                    </div>
                    ...
                    <p className={styles.bodyText}>
                        ...
                        AWS 上のシステムと PDI 接続の検証内容、Athena や Kinesis Data Firehose を含むログ分析系の記録も残していく予定です。
                    </p>
                    ...
                    <div className={styles.topicGrid}>
                        <div className={styles.topicCard}>
                            ...
                            <div>
                                ...
                                <p className={styles.topicText}>AWS、Terraform、Linux、Lambda、ミドルウェア設定のメモや検証記録</p>
                            </div>
                        </div>
                        <div className={styles.topicCard}>
                            <FileText size={18} />
                            <div>
                                ...
                                <p className={styles.topicText}>ServiceNow 学習、PDI 連携、Athena / Firehose を含む構成検証の記録</p>
                            </div>
                        </div>
                    </div>
